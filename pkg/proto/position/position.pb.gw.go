...
func RegisterPositionServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server PositionServiceServer) error {
	...
	mux.Handle("GET", pattern_PositionService_GetPosition_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		ctx, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/position.PositionService/GetPosition", runtime.WithHTTPPathPattern("/location/{device_id}"))
		if err != nil {
...
func RegisterPositionServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client PositionServiceClient) error {
	...
	mux.Handle("GET", pattern_PositionService_GetPosition_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		var err error
		ctx, err = runtime.AnnotateContext(ctx, mux, req, "/position.PositionService/GetPosition", runtime.WithHTTPPathPattern("/location/{device_id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_PositionService_GetPosition_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1}, []string{"location", "device_id"}, ""))
)
